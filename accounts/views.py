...
from carts.models import cart as Cart,cart_item as CartItem
...
def login(request):
    if request.method == 'POST':
        ...
        # or email=email if backend supports it
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # get the cart item to from the user to access his product variations
